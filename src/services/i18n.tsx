...
const zhTWTranslations: Translations = {
  ...
  langVoiceTitle: "語音合成特性設定 (Speech Harmonizers)",
  ...
  appearanceTitle: "控制台介面外觀主題 (Skins)",
  appearanceDesc: "動態調整操控控制台的主色發光波長特徵，切換全螢幕視覺氛圍。",
  skinCyanTitle: "電馭青光束 (Hologram Cyan)",
  skinCyanDesc: "標準高對比全像科技雷射 HUD 特徵 (480nm 波長)。明亮、高度科技感。",
  ...
  skinAmberDesc: "經典暖焦糖琥珀暖色面板。對比深沉、視覺優雅。",
  skinRedTitle: "裝甲極速紅 (Redline Crimson)",
  skinRedDesc: "戰鬥增壓、高對比熱力紅色色彩方案。增能發光色彩設定。",
  ...
  aboutP1: "HERMES (Heuristic Educational Real-time Memory Executive System) 整合型智慧控制核心，提供全自動任務追蹤、本機 OS 連接、BYOK 憑證同步及安全防禦機制。",
  ...
  // SysMonitor keys
  systemVitalSigns: "系統 // 資源與生命徵象監控",
  vitalSignsShort: "運行徵象",
  lblHeartRate: "主機心跳頻率",
  lblBpm: "Hz",
  lblBodyTemp: "外殼溫度",
  lblNeuralLink: "資料庫索引鏈",
  lblActiveState: "運作中",
  ...
  lblStarkSat4: "本機 SQLite DB 鏈結",
  lblSignalSecure: "FTS5 匹配加密通道",
  lblHermesCoreActive: "HERMES 核心代理程式：運作中",
  lblActivateCognitive: "啟用全自動認知協定",
  hermesMatrixTitle: "HERMES 智慧任務矩陣 v4.5",
  ...
  lblSecurityCleared: "安全金鑰防範矩陣：通過",
  lblAuthProtocol: "安全授權存取協定 IV",
  
  // Footer keys
  lblMute: "[F4] 靜音",
  lblUnmute: "[F4] 取消靜音",
  lblFullscreen: "[F11] 全螢幕",
  lblClassified: "HERMES WORKSPACE // DEVELOPER MANAGEMENT SYSTEM // SYSTEM SECURED",
  lblCopyright: "© HERMES WORKSPACE SYSTEM",

  // ActivityLog keys
  lblArmorStatus: "系統 // 硬體運作與空間狀態",
  lblPowerCore: "運算晶片能源功率",
  lblStructuralIntegrity: "硬碟空閒與健康度",
  lblSystemInteraction: "主機運作與任務流量控制",
  lblShield: "安全防禦",
  lblCorePow: "工作吞吐",
  lblSatLink: "同步更新",
  lblCalibrate: "診斷日誌",
  lblRtLog: "系統 // HERMES 決策即時日誌",
...
const enTranslations: Translations = {
  ...
  langVoiceTitle: "Speech Tuning Features",
  ...
  voiceDesc: "Calibrate speaker synthesis behavior. Choose deep acoustics or quick-paced operations officer voice structures.",
  ...
  // SysMonitor keys
  systemVitalSigns: "SYSTEM // RESOURCES & METRICS",
  vitalSignsShort: "VITAL SIGNS",
  lblHeartRate: "Workload Heartbeat",
  lblBpm: "Hz",
  lblBodyTemp: "Chassis Temp",
  ...
  lblStarkSat4: "LOCAL SQLITE DB",
  lblSignalSecure: "FTS5 ENCRYPTED CHANNEL",
  lblHermesCoreActive: "HERMES CORE GATEWAY ACTIVE",
  lblActivateCognitive: "ACTIVATE COGNITIVE PROTOCOLS",
  hermesMatrixTitle: "HERMES COGNITIVE GRID v4.5",
  ...
  lblAuthProtocol: "AUTHENTICATION PROTOCOL IV",
  
  // Footer keys
  lblMute: "[F4] Mute",
  lblUnmute: "[F4] Unmute",
  lblFullscreen: "[F11] Fullscreen",
  lblClassified: "HERMES WORKSPACE // DEVELOPER MANAGEMENT SYSTEM // CLASSIFIED",
  lblCopyright: "© HERMES WORKSPACE",

  // ActivityLog keys
  lblArmorStatus: "SYSTEM // HARDWARE RUNTIME & SPACE",
  lblPowerCore: "PROCESSING POWER",
  lblStructuralIntegrity: "STORAGE HEALTH & FREESPACE",
  lblSystemInteraction: "SYSTEM FLOW CONTROLLER",
  lblShield: "Sandbox Protection",
  lblCorePow: "Boost Capacity",
  lblSatLink: "Sync Link",
  lblCalibrate: "Diagnostic Logs",
  lblRtLog: "SYSTEM // HERMES DECISION LOG",
  ...
  lblHoloUtils: "Control console Utilities",
