        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-[230px] border-r border-cyan-900/40 bg-cyan-950/5 flex flex-col overflow-y-auto scrollbar-none py-3 px-2 flex-shrink-0 gap-1 text-[11px] font-bold">
            ...
            <div className="mt-4 pt-4 border-t border-cyan-950/30">
              ...
              <button onClick={() => setActiveMenu('cliMappings')} className={`w-full text-left px-3 py-1.5 cursor-pointer flex items-center gap-2 transition-all ${activeMenu === 'cliMappings' ? 'bg-cyan-950/40 border-r-[3px] border-cyan-400 text-cyan-300' : 'text-cyan-600/60 hover:text-cyan-500/80'}`}>
